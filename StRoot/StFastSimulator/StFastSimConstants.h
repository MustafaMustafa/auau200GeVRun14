...
namespace FastSimUtilitiesConstants
{
   ...
   std::string const hftRatioFileName       = "HFT_Ratio_VsPt_Centrality.root";
   std::string const dcaFileName           = "Dca_VsPt_Centrality.root";
   std::string const hftRatioFileName1      = "HFT_Ratio_VsPt_Centrality_Eta_Phi_Vz_Zdcx.root";
   std::string const dcaFileName1          = "Dca_VsPt_Centrality_Eta_Phi_Vz_Zdcx.root";
